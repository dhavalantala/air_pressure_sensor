...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = utils.convert_columns_float(df=base_df, excludes_columns=exclude_columns)
            train_df = utils.convert_columns_float(df=train_df, excludes_columns=exclude_columns)
            test_df = utils.convert_columns_float(df=test_df, excludes_columns=exclude_columns)
